    ...
    return (
        <div className="dataset-page" key={resource ? resource.id : 'unknown'}>
            <div className="dataset-details">
                <section>
                    <Breadcrumb
                        currentPage={resource ? resource.name : '...'}
                    />
                </section>
                <section>
                    <h2 className={resource ? '' : 'animate'}>
                        {resource?.name}
                    </h2>
                    <p className={resource ? '' : 'animate'}>
                        {informationAgency}
                    </p>
                    <RawHTML
                ...
                <section className="external-link">
                    ...
                    <img
                        alt="NYC Open Data"
                        src="https://static-assets.ny.gov/sites/all/themes/ny_gov/images/nygov-logo.png"
                    />
                    <ViewOnOpenPortal
                        permalink={dataset ? dataset?.permalink : '#'}
                    />
                </section>
            ...
            <div className="dataset-recomendataions">
                ...
                {activeTab === 'joins' &&
                    (!dataset ||
                    dataset?.resource?.columns_field_name.length > 0 ? (
                        <>
                            <p className="intro">
